...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-apply-reverb-to-everything" tabindex="-1"><a class="header-anchor" href="#_4-apply-reverb-to-everything" aria-hidden="true">#</a> 4. Apply reverb to everything</h2><p>FX are 3rd-party VST3/AU inserts on each track&#39;s rack, so a scene-wide effect is a per-track loop: list the tracks, then add the same reverb plugin to each one.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>

<span class="token assign-left variable">FAILED</span><span class="token operator">=</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
<span class="token keyword">for</span> <span class="token for-or-select variable">TRACK</span> <span class="token keyword">in</span> <span class="token variable"><span class="token variable">$(</span>sas dsl_list_tracks <span class="token parameter variable">--json</span> <span class="token operator">|</span> jq <span class="token parameter variable">-r</span> <span class="token string">&#39;.data.changes.tracks[].id&#39;</span><span class="token variable">)</span></span><span class="token punctuation">;</span> <span class="token keyword">do</span>
  sas fx_add_plugin <span class="token parameter variable">--track</span> <span class="token string">&quot;<span class="token variable">$TRACK</span>&quot;</span> --plugin-id <span class="token string">&quot;VST3/ValhallaSupermassive&quot;</span> <span class="token punctuation">\\</span>
    <span class="token operator">&amp;&amp;</span> sas dsl_fx_set_param <span class="token parameter variable">--track</span> <span class="token string">&quot;<span class="token variable">$TRACK</span>&quot;</span> <span class="token parameter variable">--fx</span> reverb --param-name wet <span class="token parameter variable">--value</span> <span class="token number">0.35</span> <span class="token punctuation">\\</span>
    <span class="token operator">||</span> <span class="token assign-left variable">FAILED</span><span class="token operator">+=</span><span class="token punctuation">(</span><span class="token string">&quot;<span class="token variable">$TRACK</span>&quot;</span><span class="token punctuation">)</span>
<span class="token keyword">done</span>

<span class="token punctuation">[</span> <span class="token variable">\${<span class="token operator">#</span>FAILED<span class="token punctuation">[</span>@<span class="token punctuation">]</span>}</span> <span class="token parameter variable">-gt</span> <span class="token number">0</span> <span class="token punctuation">]</span> <span class="token operator">&amp;&amp;</span> <span class="token builtin class-name">echo</span> <span class="token string">&quot;FX failed on: <span class="token variable">\${FAILED<span class="token punctuation">[</span>*<span class="token punctuation">]</span>}</span>&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Each <code>fx_add_plugin</code> call succeeds or fails independently, so one bad track doesn&#39;t abort the batch — the script collects failures and reports them at the end. Each failure envelope carries a <code>remediation</code> block saying why that track bounced, so the agent can retry the stragglers individually.</p><h2 id="_5-export-a-scene-as-wav" tabindex="-1"><a class="header-anchor" href="#_5-export-a-scene-as-wav" aria-hidden="true">#</a> 5. Export a scene as WAV</h2><p>Render the scene offline and save to a user-specified path.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>sas export_audio <span class="token punctuation">\\</span>
...
<span class="token comment"># 2. Tweak the mix — FX are 3rd-party inserts; plugin ids come from your scan</span>
sas fx_add_plugin <span class="token parameter variable">--track</span> <span class="token string">&quot;808&quot;</span> --plugin-id <span class="token string">&quot;VST3/TDR Kotelnikov&quot;</span>          <span class="token comment"># compressor</span>
sas fx_add_plugin <span class="token parameter variable">--track</span> <span class="token string">&quot;Lead&quot;</span> --plugin-id <span class="token string">&quot;VST3/ValhallaSupermassive&quot;</span>   <span class="token comment"># reverb</span>
sas dsl_fx_set_param <span class="token parameter variable">--track</span> <span class="token string">&quot;Lead&quot;</span> <span class="token parameter variable">--fx</span> reverb --param-name wet <span class="token parameter variable">--value</span> <span class="token number">0.2</span>
